...
export const CollectionCard = ({ className, heading }: CollectionCardProps) => {
  return (
    <div className={`bg-contain bg-no-repeat ${className}`}>
      <div className='flex flex-col items-start justify-end h-full p-8'>
        <h3 className='text-[28px] font-medium leading-[34px] tracking-[-0.6px]'>
          {heading}
        </h3>
        <Link className='cursor-pointer' to='/'>
          <button
            type='button'
            className='mt-2 gap-1 text-[14px] leading-[24px] font-medium flex underline underline-offset-2 items-center'
          >
            Collection
